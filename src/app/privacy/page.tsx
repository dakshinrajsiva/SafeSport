...
const PDF_URL = "/policies/safesport-india-privacy-policy.pdf";

export const metadata: Metadata = {
  title: "Privacy Policy",
  description:
    "Read the SafeSport India privacy policy covering how we collect, use, store, and protect personal information.",
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    title: "SafeSport India Privacy Policy",
    description:
      "How SafeSport India collects, uses, stores, and protects personal information.",
    url: "/privacy",
  },
};
        ...
        <section className="px-6 md:px-12 lg:px-24 mb-16">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl md:text-2xl font-montserrat text-gray-600 max-w-3xl leading-relaxed">
              How SafeSport India collects, uses, stores, and protects your
          ...
          <div className="max-w-7xl mx-auto">
            <div className="rounded-[2rem] overflow-hidden border border-gray-200 shadow-xl bg-[#F5F7FA]">
              <object
                ...
                aria-label="SafeSport India Privacy Policy PDF"
              >
                <iframe
                  src={PDF_URL}
                  title="SafeSport India Privacy Policy"
                  className="w-full h-[80vh] block border-0"
                />
            ...
            <div className="mt-16 p-8 md:p-10 rounded-[2rem] bg-[#F5F7FA] border border-gray-100">
              ...
              <p className="text-base md:text-lg font-montserrat text-gray-600 leading-relaxed mb-6">
                ...
                data, or wish to exercise any of your rights under applicable
                privacy laws, please get in touch.
              </p>
